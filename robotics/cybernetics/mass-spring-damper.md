...
![|400](../../attach/mass-spring-damper.webp)
...
```typst
$ dot.double(theta)(t) + frac(b, m) dot(theta)(t)+frac(k,m)theta (t)=0 $ <eq1> 
``` 
...
要让 @eq1式稳定，即 $theta_(t->infinity )=0$ ，等价于让所有特征值满足 $$Re(s_(i))<0$$ 等价于 $zeta omega_n >0$。
...
![Modern Robotics fig 11.5| 500](http://oss.jay-waves.cn/til/mass-spring-damper-error-dynamics.webp)
...
[Mass-spring-damper model -- wikipedia](https://en.wikipedia.org/wiki/Mass-spring-damper_model)
