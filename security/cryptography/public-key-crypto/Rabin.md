...
由 $c$ 是模 $p$ 的[二次剩余](../../../math/numth/二次剩余.md), 知 $\left( \frac{c}{p} \right)\equiv c^{\frac{p-1}{2}}\equiv 1\pmod p$.
...
每组皆可用[中国剩余定理](../../../math/numth/中国剩余定理.md)求解. 为确定有效明文, $m$ 中常加入某些协商信息, 如日期和ID.