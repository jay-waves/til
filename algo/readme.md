...
使用 kernel 风格 [kernel c style](../langs/c/kernel%20c%20style.md), 内容为组合优化.
...
[^1]: 详见 [ReadMe](../langs/cpp/数据类型/STL/ReadMe.md)d)
...
- 排序: 
	- [插入排序](排序/insertion-sort.md)
	- [堆排序](排序/heap-sort.md), 
	- [归并排序](排序/merge-sort.md), 
	- [快速排序](排序/quick-sort.md), 
	- [冒泡排序](排序/bubble-sort.md#冒泡排序), 
	- [希尔排序](排序/shell-sort.md), 
	- [选择排序](排序/selection%20-sort.md)
- 图和搜索算法: 
	- [二分查找](排序/binary-search.md)
	- [广度优先搜索](图论/广度优先搜索.md), 
	- [深度优先搜索](图论/深度优先搜索.md)
	- 最小生成树
		- Prim 
