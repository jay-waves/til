...
- 文内引用学术论文时, 括号中使用 Harvard 风格注明作者和发表年份: `[yjw, 2023]`, 直接链接到作品. 
- 文内引用著作时, 括号中使用 IEEE 风格, 即 Markdown 注脚语法, 并标明著作名和页数.
...
- 数学证明中, 每行由条件开启, 用结论结束, 构成一条明显的因果关系. 用 `证明:` 和 $\blacksquare$ 标识开始与结束.
