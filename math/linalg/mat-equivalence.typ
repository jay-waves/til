...
#lemma[$upright("rank") ( A ) lt.eq n$, 即 $upright("rank") ( A ) lt.eq upright("min") { m \, med n }$. 其中 $upright("rank")(A)$ 是行秩或列秩.]
...
#proof[
  ...
  #link("linear-systems/solutions-of-linear-systems.typ")[线性方程组] $B upright(bold(x)) = 0$ 的解空间, 属于 $A B upright(bold(x)) = 0$ 的解空间, 即 $nothing_B subset.eq nothing_(A B)$.  
