...
<img src="../../../assets/math/math-analytic-geometry-generatrix-directrix.avif" alt="" width="400">
...
<img src="../../../assets/math/math-analytic-geometry-circular-cylinder.avif" alt="圆柱面" width="400">

**椭圆柱面**: $$\frac{x^2}{a^2}+\frac{y^2}{b^2} = 1$$

<img src="../../../assets/math/math-analytic-geometry-elliptic-cylinder.avif" alt="椭圆柱面" width="400">

**双曲柱面**: $$\frac{x^2}{a^2}-\frac{y^2}{b^2} = 1$$

<img src="../../../assets/math/math-analytic-geometry-hyperbolic-cylinder.avif" alt="双曲柱面" width="400">

**抛物柱面**: $$y^2 = 2px$$

<img src="../../../assets/math/math-analytic-geometry-parabolic-cylinder.avif" alt="抛物柱面" width="400">
...
<img src="../../../assets/math/math-analytic-geometry-cone.avif" alt="锥面" width="400">
...
<img src="../../../assets/math/math-analytic-geometry-circular-cone.avif" alt="圆锥面" width="400">
...
**半顶角求法:**  
设 $M(x_0,y_0,z_0)$ 为圆锥面的顶点, 轴线方向向量 $\vec{v} = (X,Y,Z)$, $M(x,y,z)$ 在圆锥面上. 则半顶角为 
$$\alpha:\frac{\overrightarrow{M_0M}\cdot\vec{v}}{|\overrightarrow{M_0M}|\cdot|\vec{v}|} = \pm\cos\alpha$$
...
<img src="../../../assets/math/math-analytic-geometry-surface-of-revolution.avif" alt="旋转曲面" width="400">
...
<img src="../../../assets/math/math-analytic-geometry-surface-of-revolution-1.avif" alt="" width="400">
...
<img src="../../../assets/math/math-analytic-geometry-ellipsoid.avif" alt="" width="400">
...
<img src="../../../assets/math/math-analytic-geometry-one-sheet-hyperboloid.avif" alt="" width="400">
...
<img src="../../../assets/math/math-analytic-geometry-two-sheet-hyperboloid.avif" alt="双叶双曲面" width="400">
...
<img src="../../../assets/math/math-analytic-geometry-asymptotic-cone.avif" alt="渐进锥面" width="400">
...
<img src="../../../assets/math/math-analytic-geometry-elliptic-paraboloid.avif" alt="椭圆抛物面" width="400">

椭圆抛面关于两个坐标面以及一个坐标轴对称, 但是没有对称中心. 

<img src="../../../assets/math/math-analytic-geometry-paraboloid-1.avif" alt="" width="400">
...
<img src="../../../assets/math/math-analytic-geometry-hyperbolic-paraboloid.avif" alt="双曲抛物面" width="400">

两个所在平面相互垂直, 有公共顶点和轴, **开口相反**的两个抛物线, 让其中一个抛物线平行于自己, 顶点位于另一个抛物线上滑动, 形成一个双曲抛物线.

<img src="../../../assets/math/math-analytic-geometry-hyperbolic-paraboloid-1.avif" alt="" width="400">
...
1. $u$ 族直线: 
$$(\frac{x}{a}+\frac{z}{c})(\frac{x}{a}-\frac{z}{c}) = (1+\frac{y}{b})(1-\frac{y}{b})\Rightarrow
\left\{\begin{matrix} 
...
<img src="../../../assets/math/math-analytic-geometry-one-sheet-hyperboloid-2.avif" alt="" width="400">

1.  为了避免取极限, 通常将单叶双曲面的直母线写为 
$$\left\{\begin{matrix} 
...
1.  $u$ 族直线: 
$$(\frac{x}{a}+\frac{y}{b})(\frac{x}{a} - \frac{y}{b}) = 2z\Rightarrow
\left\{\begin{matrix} 
...
<img src="../../../assets/math/math-analytic-geometry-hyperbolic-paraboloid.avif" alt="" width="400">
...
https://www.cnblogs.com/RadiumGalaxy/p/16979030.html RadiumStar
