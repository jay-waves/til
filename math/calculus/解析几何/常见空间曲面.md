...
![|400](http://oss.jay-waves.cn/til/母线与准线.avif)
...
![圆柱面|400](http://oss.jay-waves.cn/til/圆柱面.avif)

**椭圆柱面**: $$\frac{x^2}{a^2}+\frac{y^2}{b^2} = 1$$

![椭圆柱面|400](http://oss.jay-waves.cn/til/椭圆柱面.avif)

**双曲柱面**: $$\frac{x^2}{a^2}-\frac{y^2}{b^2} = 1$$

![双曲柱面|400](http://oss.jay-waves.cn/til/双曲柱面.avif)

**抛物柱面**: $$y^2 = 2px$$

![抛物柱面|400](http://oss.jay-waves.cn/til/抛物柱面.avif)
...
![锥面|400](http://oss.jay-waves.cn/til/锥面.avif)
...
![圆锥面|400](http://oss.jay-waves.cn/til/圆锥面.avif)
...
![旋转曲面|400](http://oss.jay-waves.cn/til/旋转曲面.avif)
...
![|400](http://oss.jay-waves.cn/til/旋转曲面1.avif)
...
![|400](http://oss.jay-waves.cn/til/椭球面.avif)
...
![|400](http://oss.jay-waves.cn/til/单叶双曲面.avif)
...
![双叶双曲面|400](http://oss.jay-waves.cn/til/双叶双曲面.avif)
...
![渐进锥面|400](http://oss.jay-waves.cn/til/渐进锥面.avif)
...
![椭圆抛物面|400](http://oss.jay-waves.cn/til/椭圆抛物面.avif)

椭圆抛面关于两个坐标面以及一个坐标轴对称, 但是没有对称中心. 

![|400](http://oss.jay-waves.cn/til/抛物面1.avif)
...
![双曲抛物面|400](http://oss.jay-waves.cn/til/双曲抛面.avif)

两个所在平面相互垂直, 有公共顶点和轴, **开口相反**的两个抛物线, 让其中一个抛物线平行于自己, 顶点位于另一个抛物线上滑动, 形成一个双曲抛物线.

![|400](http://oss.jay-waves.cn/til/双曲抛物面1.avif)
...
![|400](http://oss.jay-waves.cn/til/单页双曲面.avif)
...
![|400](https://oss.jay-waves.cn/til/双曲抛物面.avif)
