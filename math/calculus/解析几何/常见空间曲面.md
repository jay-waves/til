...
<img src="http://oss.jay-waves.cn/til/母线与准线.avif" alt="" width="400">
...
<img src="http://oss.jay-waves.cn/til/圆柱面.avif" alt="圆柱面" width="400">

**椭圆柱面**: $$\frac{x^2}{a^2}+\frac{y^2}{b^2} = 1$$

<img src="http://oss.jay-waves.cn/til/椭圆柱面.avif" alt="椭圆柱面" width="400">

**双曲柱面**: $$\frac{x^2}{a^2}-\frac{y^2}{b^2} = 1$$

<img src="http://oss.jay-waves.cn/til/双曲柱面.avif" alt="双曲柱面" width="400">

**抛物柱面**: $$y^2 = 2px$$

<img src="http://oss.jay-waves.cn/til/抛物柱面.avif" alt="抛物柱面" width="400">
...
<img src="http://oss.jay-waves.cn/til/锥面.avif" alt="锥面" width="400">
...
<img src="http://oss.jay-waves.cn/til/圆锥面.avif" alt="圆锥面" width="400">
...
<img src="http://oss.jay-waves.cn/til/旋转曲面.avif" alt="旋转曲面" width="400">
...
<img src="http://oss.jay-waves.cn/til/旋转曲面1.avif" alt="" width="400">
...
<img src="http://oss.jay-waves.cn/til/椭球面.avif" alt="" width="400">
...
<img src="http://oss.jay-waves.cn/til/单叶双曲面.avif" alt="" width="400">
...
<img src="http://oss.jay-waves.cn/til/双叶双曲面.avif" alt="双叶双曲面" width="400">
...
<img src="http://oss.jay-waves.cn/til/渐进锥面.avif" alt="渐进锥面" width="400">
...
<img src="http://oss.jay-waves.cn/til/椭圆抛物面.avif" alt="椭圆抛物面" width="400">

椭圆抛面关于两个坐标面以及一个坐标轴对称, 但是没有对称中心. 

<img src="http://oss.jay-waves.cn/til/抛物面1.avif" alt="" width="400">
...
<img src="http://oss.jay-waves.cn/til/双曲抛面.avif" alt="双曲抛物面" width="400">

两个所在平面相互垂直, 有公共顶点和轴, **开口相反**的两个抛物线, 让其中一个抛物线平行于自己, 顶点位于另一个抛物线上滑动, 形成一个双曲抛物线.

<img src="http://oss.jay-waves.cn/til/双曲抛物面1.avif" alt="" width="400">
...
<img src="http://oss.jay-waves.cn/til/单页双曲面.avif" alt="" width="400">
...
<img src="https://oss.jay-waves.cn/til/双曲抛物面.avif" alt="" width="400">
