...
根据[代数基本定理](../algebra/环/多项式环.md#代数基本定理), $$x^{n}=1$$ 在复数域上有 $n$ 个解, 分别为: $$\exp\left[ \frac{2k\pi i}{n} \right]=\cos\left( \frac{2k\pi}{n} \right)+i\cdot \sin\left( \frac{2k\pi}{n} \right),\quad k=0,1,2,\dots,n-1$$
