...
- 参与者间网络连接情况: 见 [physical-l1](../../../networks/physical-l1.md)
- 协议参与者的诚实程度: 
	- 诚实参与者
...
常见的认证协议有:
- Kerberos, 基于单钥
- [SAML](../../../distributed/认证授权/SAML.md)
- [OAuth](../../../distributed/认证授权/OAuth.md), 开放认证协议.

常见的密钥协议协议有:
- [DiffieHellman](../public-key-crypto/DiffieHellman.md)
- [RSA 密钥交换](../public-key-crypto/RSA/RSA.md)
- [ECDH](../public-key-crypto/ECC/ECC.md)
- IKE, 用于 [ipsec](../../../networks/firewalls&vpn/ipsec.md)
...
2. 电子支付和电子商务安全协议, 保证在线支付和数字货币的安全性.
	...
	- 3D Secure.
1. 匿名路由协议. 保护流量隐私.
	- [Tor, 洋葱路由协议](../../../networks/firewalls&vpn/vpn.md)
	- I2P
	- Mixnets, 混合网络
1. 隐私计算协议. 使数据的处理和分析可以在保护数据隐私的前提下进行. 关注计算复杂度, 通信复杂度和安全性三个维度.
	...
	- [秘密共享和分拆协议](秘密分拆协议.md). 如 (Shamir & Blakley 方案, 1979), SPDZ 协议, GMW 协议.
...
- [provable-security](../provable-security.md), 基于困难性问题归约证明
