卷积和相关知识见[数字信号处理:卷积与相关](../../数学/信号与系统/卷积与相关.md), 图像中卷积一般指互相关 (cross correlation): $$\large O[i,j]=(I*K)[i,j]=\sum\limits_{m}\sum\limits_{n}I[i+m,j+n]\cdot K[m,n]$$ 其中 $K$ 称为变换核.
...
**缺点:**
- 复数运算费时 (尽管有 [FFT](../../数学/数值分析/快速傅里叶变换.md))
