...
<img src="../../assets/hw/hw-cpu-internal-architecture.avif" alt="" width="500">
...
[数字信号](../../robotics/cybernetics/signals.md)处理器 (DSP) 针对通信 / 图像 / 语音 / 视频 领域的算法. 主要是乘法器的优化, 包括 卷积 / 数字滤波 / FFT / 矩阵运算 中的大量重复乘法. 主要是 德州仪器 (TI) 和 美国模拟器件公司 (ADI) 供应.
