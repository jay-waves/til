...
| `nslookup`      | 查询 [DNS](../../Network/Application%20Layer/DNS.md), 简单信息(IP, CNAME)    | `nslookup google.com`        |                 |
| `dig`           | 查询 [DNS](../../Network/Application%20Layer/DNS.md), 详细信息(A, MX, TXT)   |                              |                 |
...
## [DNS](../../Network/Application%20Layer/DNS.md) 工具
