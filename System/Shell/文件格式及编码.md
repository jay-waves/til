常见编码与序列化格式:
- [UTF-8](../Development/character%20encoding.md)... 将文本表达为字节序列.
- [BaseN](../Development/base-N%20encoding.md)... 将二进制表达为受限 ASCII 字符串 (指可见的, 不易混淆的字符)
...
`iconv` 更改[character encoding](../Development/character%20encoding.md)方式. 
