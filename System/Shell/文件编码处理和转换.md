...
| 名称   | 作用                                                                | 例子                                                         |
| ------ | ------------------------------------------------------------------- | ------------------------------------------------------------ |
| [Base64](../../Miscellaneous/数据格式/Base.md) | 用于将文件/图片的二进制数据, 编码为纯 ASCII 字符串.| `YGlklD4gZXh6ZHYudHh0YA==`                                                          |
| [Base58](../../Miscellaneous/数据格式/Base.md) | 类似 Base64, 去除了易混淆的 O0Il, 用于比特币                        |                                                              |
| Hex    | 二进制转化为十六进制字符串. 用于加密和校验                          |                                                              |
|  [XML](../../Miscellaneous/数据格式/XML.md)   |                                                                     |                                                              |
| [YAML](../../Miscellaneous/数据格式/YAML.md)   | 类似 JSON, 更反人类一点. 既不易读, 也不易懂...                                                                    |                                                              |
| [JSON](../../Miscellaneous/数据格式/JSON.md)   | 文本交换格式, 自带简单数据结构, 便于解析.                             |                                                              |
| HTML   | 用于在 HTML 中标识特殊字符, 避免和标签关键字冲突.                   | `&apos, &lt, &gt, &times, &divide, &amp, &quot, &nbsp, &copy, &reg` |
| [URL](../../Miscellaneous/数据格式/URL.md)   | 用于避免 URL 中的特殊字符                            | `Hello%20world%21`                                           |
...
`iconv` 更改[字符串编码](../../HardWare/字符串编码.md)方式. 
