...
1. *数据保密性, Data Confidentiality.*
	- Data confidentiality, 数据内容保密性.
		- Connection confidentiality. 有连接通信 ([TCP](../网络通信/传输层/TCP.md)), 对整个会话状态和数据分组进行加密. 如 [SSL/TLS](../网络通信/VPN/SSL.md) 技术.
		- Connectionless confidentiality. 无连接通信 ([UDP](../网络通信/传输层/UDP.md)), 对单个数据包独立加密. 如 [IPSec ESP](../网络通信/VPN/IPSec.md) 技术.
...
2. *数据完整性, Data Integrity.*
	...
	- Connectionless integrity, 独立数据包的完整性. 如 [IPSec AH](../网络通信/VPN/IPSec.md) 技术. 
...
[X.800, 1991] 和 [RFC 4949, 2007] 都定义了安全服务所处的[网络层次](../网络通信/网络体系结构.md), 不过随着技术进步和定义变化, 下表在不同标准间区别较大, 仅作参考.
