...
由[算术基本定理](../../../../数学/数论/质数.md), 一个合法 RSA 模数 $N$ 只有唯一一种分解 $p\cdot q$.
...
- [欧几里得算法](../../../../数学/数论/欧几里得算法.md) 求最大公因子和逆元.
- [快速模幂算法](../../../../数学/数论/快速模幂算法.md) 求指数运算.
- [米勒罗宾方法](../../../../数学/数论/素性检测-米勒罗宾方法.md) 判断素数, 概率性算法.
