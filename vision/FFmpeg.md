...
| 图像格式    | 压缩       | 最大色深                   | 灰度色深 | 色域                              | 动态范围 | 描述                 |     
| ------- | ---------- | -------------------------- | -------- | --------------------------------- | -------- | --- |
| JPEG    | 有损压缩   | RGB24b                     | 8b       | sRGB                              | SDR      | 基于 DCT                |
| JPEG XT |            | RGB32b                     |          |                                   |          | 有版权问题          |
| PNG     | 无损压缩   | RGB64b (16 * 4)            | 16b      | sRGB                              | SDR      |                     |
| GIF     | 无损压缩   | RGB8b                      |          | sRGB                              | SDR      | 支持动画              |
| HEIF    | 有损压缩   | RGBA40b (10 * 4)           |          | sRGB, DCI-P3 (宽色域)             | HDR      | 基于 H.265 技术      |
| AVIF    | 有损压缩   | RGBA48b (12 * 4)           |          | sRGB, DCI-P3                      | HDR      | 基于 AV1 技术          |
| WebP    | 有损、无损 | RGB32b (8 * 4 )            |          | sRGB, DCI-P3                      | HDR      |                        |
| TIFF    |            | RGBA/CMYK 32b * 4 (含浮点) |          | sRGB, Adobe RGB, DCI-P3, Rec.2020 | SDR      | 支持动画    |
