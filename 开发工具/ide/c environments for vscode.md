...
[^1]: 参见 [C ReadMe](../../编译器/运行时/C%20标准库.md), UCRT 为微软 MSVCrt 标准库的升级版. 在 Windows 平台上, 默认的 C 标准为 UCRT, C++ 标准为 MSVC++. 皆在 Visual Studio 套件中.
...
[^6]: cl.exe 编译器详见 [msvc](../../编译器/工具链/msvc.md).md)l.md)