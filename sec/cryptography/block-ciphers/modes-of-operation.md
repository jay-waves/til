...
<img src="/assets/sec/sec-crypto-ecb-chaining-mode.avif" alt="" width="200">
迭代公式为:[^1] 
...
<img src="../../../assets/sec/sec-crypto-ecb-plaintext-leakage.avif" alt="" width="400">
## CBC
...
<img src="../../../assets/sec/sec-crypto-cbc-chaining-mode.avif" alt="" width="400">
...
<img src="../../../assets/sec/sec-crypto-cfb-chaining-mode.avif" alt="" width="200">
### CFB + LSB 
...
<img src="../../../assets/sec/sec-crypto-cfb-chaining-mode-lsb.avif" alt="" width="650">
## OFB
...
<img src="../../../assets/sec/sec-crypto-ofb-chaining-mode.avif" alt="" width="200">
## CTR
...
<img src="../../../assets/sec/sec-crypto-ctr-chaining-mode.avif" alt="" width="150">
## GCM
...
<img src="../../../assets/sec/crypto-aes128-gcm.avif" alt="" width="600">
## 安全特性
...
非流密码的模式需要[明文填充](padding.md), 使其长度对齐分组密码输入长度 (恰好对齐也要额外填充).... 可能导致...
...
[流密码自同步能力](../stream-ciphers&prng/流密码与伪随机数.md): 各项无码扩展...

CBC 无自同步能力. 流密码都有自同步能力.

### 随机访问

**扩散性**: 影响硬盘写入次数, 最终影响吞吐量, 以及硬盘寿命.
