...
针对使用 PKCS#7 填充方式与 [CBC 链接模式](modes-of-operation.md)的分组密码的攻击方式. 利用解密时, PKCS#7 填充检查的错误反馈, 构造 CCA2 选择密文攻击.
...
<img src="../../../assets/sec/crypto-padding-attack.avif" alt="" width="300">
