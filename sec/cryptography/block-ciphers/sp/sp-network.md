...
**单轮流程**:
<img src="/assets/sec/sec-crypto-substitution-permutation-structure.avif" alt="" width="300">
...
通常用两不同幂等密码的乘积 $S_{1}\times S_{2}$ 来构造 *非幂等密码*, 但需保证两者不可交换. 参见[EDE](../feistel/EDE.md)
