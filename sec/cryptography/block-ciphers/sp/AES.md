...
<img src="../../../../assets/sec/crypto-aes.avif" alt="" width="250">
...
等效解密结构: **为了让加解密结构更加类似, AES 最后一轮没有 `MixColumns`.** 原理一见[代换置换网络](sp-network.md), 即 `MixColumn` 和 `AddRoundKey` 可在线性变换条件下互换位置; 二需理解 `SubBytes` 和 `ShiftRows` 结构可互换位置, 因为 `ShiftRows` 不改动字节内部值.
...
<img src="../../../../assets/sec/crypto-aes-key-extend.avif" alt="" width="550">
...
字节扩散效果:
<img src="../../../../assets/sec/crypto-aes-avalanche.avif" alt="" width="450">
