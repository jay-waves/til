...
当私钥 $d$ 过小且满足: $3d<n^{\frac{1}{4}}$, 且 $q < p < 2q$，使用 **[连分数理论](../../../../../math/numth/连分数理论.md)** 在多项式时间内破解 $d$.
...
由 [Legendre's theorem](../../../../../math/numth/连分数理论.md) 知, 若 $\mid x\ -\ \frac{a}{b}\mid \ <\ \frac{1}{2b^2}$, 其中 x 为分数, ab 为不互质的正整数, 那么 $\frac{a}{b}$ 必然是 x 的一个收敛分数.  
