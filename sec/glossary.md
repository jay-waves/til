...
[oauth](../db/distributed/auth/oauth.md), 一种开放标准授权协议, 允许用户授权第三方访问其资源而无需暴露凭据. 
...
[saml](../db/distributed/auth/saml.md), Security Assertion Markup Language, 用于单点登录 (SSO) 和身份联合的标准. 

### SQL

数据库结构化查询语言, 见 [Data Storage/SQL](../db/sql/sql.md).
