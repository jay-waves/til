计算机标识时间的格式是 UTC (Coordinated Universal Time), 该格式和具体时区无关, 如: `UTC 15:00 minus 7 hours`. Unix epoch 使用 UTC 的秒格式, 如 `1407694710`, 其含义是从 `UTC 1970-1-1 00:00:00` [^1] 开始的秒数.
