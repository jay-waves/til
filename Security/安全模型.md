...
| B3       | 安全域 (Security Domains)                        | 第五级, <br> 绝密级(涉密) | DAC+MAC, I&A, 审计, 资源隔离, 安全域          |
| B2       | 结构化保护 (Structural Protection)               | 第四级, <br> 机密级(涉密) | DAC+MAC, I&A, 审计, 资源隔离, 架构化         |
| B1       | 标记安全保护 (Labeled Security Protection)       | 第三级, <br> 秘密级(涉密) | DAC+MAC, I&A, 审计, 资源隔离         |
| C2       | 受控的存取保护 (Controlled Access Protection)    | 第二级                    | DAC, I&A, 审计, 资源隔离         |
| C1       | 自动安全保护 (Discretionary Security Protection) | 第一级                    | DAC, I&A         |
