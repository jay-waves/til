...
| **[MD-5](MD-5.md)**         | 无限制     | 512                  | 32       | 128                  | Merkle-Damgard 迭代结构, 已淘汰         |
| **[SM-3](SM-3.md)**         | $<2^{64}$  | 512                  | 32       | 256                  | 仿 SHA256, 中国国密标准                 |
...
Sponge 结构虽然支持任意长度输出, 但是标准算法都会固定一些输出长度, 以更安全地算法实现.
