...
SM2 密钥协商基于 [ECDH](Security/密码学/公钥密码/DiffieHellman%20协议.md), 额外引入了随机数 $r$ 进行协商, 假设私钥 $d$, 公钥 $P$.
...
最初想法基于 [ECDH](ECC.md), 但复杂化私钥 $t=d+r$, 思路参考 [MTI 协议](Security/密码学/公钥密码/MTI%20协议.md)  
