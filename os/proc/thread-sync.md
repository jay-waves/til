...
比较经典的算法是：[Lock-Free Queue](../../algo/concurrency/lock-free-queue.md), Mihael1996.

#### CAS 

详见 [cas](../../algo/concurrency/cas.md)

```go
func CompareAdnSwapInt32(addr* int32, old, new int32) (swapped bool)
```
...
<img src="../../assets/os/os-process-deadlock.avif" alt="" width="200">
