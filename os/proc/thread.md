...
<img src="../../assets/os-process-control-block.avif" alt="" width="150">

进程控制块, PCB, Process Control Block:

操作系统用于存储进程相关信息的数据结构, 存放在独立内存区域. 

<img src="../../assets/os-process-memory-layout.avif" alt="" width="150">
...
<img src="../../assets/os-thread-process-resource-mapping.avif" alt="" width="400">
