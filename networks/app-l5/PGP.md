...
| 服务         | 功能     | 算法          | 描述               |
| ------------ | -------- | ------------- | ------------------ |
| **认证**     | 数字签名 | [DSS](../../netsec/密码学/公钥密码/数字签名/数字签名.md#3%20DSA%20数字签名)/[RSA](../../netsec/密码学/公钥密码/RSA/RSA.md) + [SHA](../../netsec/密码学/消息摘要/消息摘要.md) | 哈希和数字签名套件 |
| **保密**     | 消息加密 | CAST5, [AES](../../netsec/密码学/分组密码/SP%20结构/AES.md), [IDEA](../../netsec/密码学/分组密码/SP%20结构/IDEA.md), [3DES](../../netsec/密码学/分组密码/Feistel%20结构/EDE.md), Blowfish    | 内容对称加密       |
| **压缩**     |          | ZIP           |                    |
...
PGP 依赖于[公钥基础设施](../../netsec/密码学/安全协议/密钥分发与管理.md)进行管理和分发, 但自身没有完善证书管理体系. 支持公钥信任链.
...
1. 发送方首先生成一个随机的**[对称密钥](../../netsec/密码学/分组密码/分组密码.md)** $K$ 作为本次[会话密钥](../../netsec/密码学/安全协议/密钥分发与管理.md).
2. 使用会话密钥 $K$ 对消息内容 $M$ 加密: $$C_{M}=\{ M \}_{K}$$
3. 发送方会提前获知接收者的公钥 $PK$, 对会话密钥进行加密: $$C_{K}=\{ K \}_{PK}$$
4. (可选) 对原始消息 $M$ 进行[数字签名](../../netsec/密码学/公钥密码/数字签名/数字签名.md), 供接收方确认消息真实性和完整性: $$S=\{ Hash(M)\}_{SK'}$$
