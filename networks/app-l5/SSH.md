...
1. **建立 TCP 连接**
2. **协商协议版本号, 协商密码算法**
3. **密钥建立**: 用 [DH](../../netsec/cryptography/public-key-crypto/DiffieHellman.md) 或 [ECDH](../../netsec/cryptography/public-key-crypto/ECC/ECC.md) 密钥交换算法生成会话密钥 $K$, 会话 ID. $K$ 用于保密后续的认证和数据传输.
