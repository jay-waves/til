...
- 嵌入 C 代码使用 [Kernel 风格](../langs/c/kernel%20c%20style.md)
- 嵌入 C++ 和 Go 代码使用 [Google 风格](../langs/cpp/Google%20C++%20Style.md).
- 嵌入 Python 使用 [pep8 style](../langs/python/pep8%20style.md) 风格.
