...
- 网络与事件异步编程, 见 [Network/Programming](../操作系统/io%20&%20ipc/ReadMe.md)
...
一种函数反射方法, 见 [运行时函数多态](c++/面向对象/运行时函数多态.md#函数体).

#### System Call

系统调用. 见 [中断与异常](../操作系统/process/中断与异常.md).
...
信号量. 见 [进程同步与互斥](../操作系统/process/进程同步与互斥.md).

#### Synchronization

进程间同步, 见 [进程同步与互斥](../操作系统/process/进程同步与互斥.md).

#### Read-Write Lock

读写锁. 见 [进程同步与互斥](../操作系统/process/进程同步与互斥.md)
...
抢占式调度. 见 [进程调度](../操作系统/process/进程调度.md)

#### Interrupt

操作系统中断, 见 [中断与异常](../操作系统/process/中断与异常.md)
