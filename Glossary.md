...
[OAuth](Network/Backend/用户认证/OAuth.md), 一种开放标准授权协议, 允许用户授权第三方访问其资源而无需暴露凭据. 
...
[SAML](Network/Backend/用户认证/SAML.md), Security Assertion Markup Language, 用于单点登录 (SSO) 和身份联合的标准. 
